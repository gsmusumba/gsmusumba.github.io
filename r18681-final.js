/* GS MUSUMBA R186.82 — FINAL GLOBAL UI + LIVE SUPABASE TIMETABLE AUTHORITY */
(function(){'use strict';
 ...
 /* Make identification importer use the included R186.82 CSV without stale cache. */
 window.GSM_R18681={release:'R186.82',globalContrast:true,serviceFocusGlobal:true,duplicateTitleAuthority:true,timetableSource:'LIVE_SUPABASE',periodBackground:'DARK_NAVY_WHITE_TEXT',includedIdentificationCsv:'GS_MUSUMBA_STUDENT_IDENTIFICATION_SDMS_990.csv'};
 if(window.GSM_R18628)window.GSM_R18628.currentTimetable='LIVE_SUPABASE';
 try{document.documentElement.setAttribute('data-gsm-release','R186.82');document.documentElement.setAttribute('data-gsm-component-release','R186.82')}catch(_){}
