/* R186.69 staged application loader: login first, heavy workspace only after authentication. */
(function(){'use strict';
 if(window.GSM_loadAppExtensions)return;
 let promise=null;const started=performance.now();
 const APP_CSS='./r18661-app.css?v=R186.69',APP_JS='./r18661-extensions.js?v=R186.69';
