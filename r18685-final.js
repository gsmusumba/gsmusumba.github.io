/* GS MUSUMBA R186.85 — FINAL DASHBOARD + MARKS + TIMETABLE PRINT AUTHORITY */
(function(){'use strict';
 ...
 /* ---------------- R186.85 OFFICIAL TIMETABLE PRINTING ---------------- */
 ...
 /* Make identification importer use the included R186.85 CSV without stale cache. */
 window.GSM_R18681={release:'R186.85',globalContrast:true,serviceFocusGlobal:true,duplicateTitleAuthority:true,timetableSource:'LIVE_SUPABASE',periodBackground:'DARK_NAVY_WHITE_TEXT',includedIdentificationCsv:'GS_MUSUMBA_STUDENT_IDENTIFICATION_SDMS_990.csv'};
 if(window.GSM_R18628)window.GSM_R18628.currentTimetable='LIVE_SUPABASE';
 try{document.documentElement.setAttribute('data-gsm-release','R186.85');document.documentElement.setAttribute('data-gsm-component-release','R186.85')}catch(_){}
 setTimeout(()=>globalUi(document),120);setTimeout(()=>globalUi(document),700);
})();

/* ===== R186.85 MOBILE OPERATIONS + MARKS LIVE FORMULA / ALL-MARKS AUDIT ===== */
(function(){'use strict';
 ...
 window.GSM_R18684={release:'R186.85',mobileAttendance:'CARD_ROSTER_REASON_DIRECT',mobileScroll:'UNFROZEN',studentSave:'VISIBLE_GREEN',marksLiveFormula:'RAW_CAMIS_EXAM_PERCENT_GRADE_RANK',allMarks:'FULL_ASSESSMENT_MATRIX_AND_COUNTS',exclusiveServices:true,canonicalHost:'musumba.pages.dev'};
 try{document.documentElement.setAttribute('data-gsm-release','R186.85');document.documentElement.setAttribute('data-gsm-component-release','R186.85')}catch(_){}
 setTimeout(()=>enhance(document),120);setTimeout(()=>enhance(document),700);
})();


/* ===== R186.85 GLOBAL EXCLUSIVE SERVICE + MOBILE SCROLL + OLD-ASSET GUARD ===== */
(function(){'use strict';
  if(window.__GSM_R18685_AUTHORITY__)return;
  window.__GSM_R18685_AUTHORITY__=true;
  const RELEASE='R186.85';
